...
class bounceButton: UIButton {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
       ...
       // UIView.animate(withDuration: 5, delay: 0, usingSpringWithDamping: 0.1, initialSpringVelocity: -2, options: .curveEaseInOut, animations: {self.transform = CGAffineTransform.identity}, completion: nil)
